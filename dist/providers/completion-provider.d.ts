...
export declare class AICompletionProvider implements vscode.CompletionItemProvider {
    ...
    provideCompletionItems(document: vscode.TextDocument, position: vscode.Position, token: vscode.CancellationToken): Promise<vscode.CompletionItem[] | vscode.CompletionList | null>;
